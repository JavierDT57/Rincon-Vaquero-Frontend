// src/pages/Destinos/DestinoDetallePage.jsx
import DestinoDetalleContainer from "../../containers/Destinos/DestinoDetalleContainer";
...
export default function DestinoDetallePage() {
  const { data } = DestinoDetalleContainer();
    ...
    >
      <div className="space-y-12">
        <section>
          ...
          <p className="text-lg text-muted-foreground leading-relaxed">{data.sections.queEs}</p>
        </section>
