...
export default function TiendaCreatePublication({
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setLocalError(err?.message || "Error al crear la publicación.");
    } finally {
      setSubmitting(false);
    }
  };
        ...
        <div className="rounded-2xl bg-white ring-1 ring-black/5 p-6 animate-fadeIn">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div>
              ...
              {preview && (
                <div className="mt-3 overflow-hidden rounded-xl ring-1 ring-black/5">
                  <img src={preview} className="h-48 w-full object-cover" alt="Vista previa" />
                </div>
              )}
            </div>
            ...
            <div className="flex justify-end gap-3 pt-2">
              ...
              <button type="submit" disabled={submitting} className="rounded-xl bg-blue-600 px-5 py-2.5 text-white font-medium shadow hover:opacity-90 disabled:opacity-60">
