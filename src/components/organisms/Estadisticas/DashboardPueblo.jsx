            ...
            <div className="flex items-start justify-between">
              <div>
                <button
                  ...
                  className="inline-flex items-center gap-2 rounded-full border border-white/70 bg-white/20 px-3 py-1.5 text-white backdrop-blur hover:bg-white/30 transition mb-4"
                >
                  <svg width="18" height="18" viewBox="0 0 24 24" fill="none"><path d="M15 6l-6 6 6 6" stroke="currentColor" strokeWidth="2" strokeLinecap="round"/></svg>
                  Volver
                </button>
